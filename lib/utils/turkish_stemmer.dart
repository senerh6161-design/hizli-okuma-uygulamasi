...
List<String> turkishStemCandidates(String word) {
  ...
  List<String> stripOneRound(String base) {
    ...
    for (final suffix in _suffixes) {
      // >= 2 olmalı: "iş", "göz", "el", "su" gibi pek çok Türkçe kök 2
      // harfli — eşik 3 iken bunlar hiç aday olarak üretilmiyordu (ör.
      // "işler" TDK'de doğrudan bulunamıyor, kökü "iş" aranmalıydı).
